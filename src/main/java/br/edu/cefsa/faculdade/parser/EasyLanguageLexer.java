...
public class EasyLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAMA", "LEIA", "ESCREVA", "SE", "ENTAO", "SENAO", "ENQUANTO", "FACA", 
			"PARA", "DE", "ATE", "PASSO", "INTEIRO", "BOOLEANO", "TEXTO", "BOOL", 
			"ATRIBUICAO", "MAIOR", "MENOR", "MAIOR_IGUAL", "MENOR_IGUAL", "IGUAL", 
			"DIFERENTE", "MAIS", "MENOS", "MULT", "DIV", "MOD", "ABRE_PAR", "FECHA_PAR", 
			"ABRE_CHAVE", "FECHA_CHAVE", "VIRGULA", "PONTO_VIRGULA", "NUM", "STRING", 
			"ID", "WS", "COMMENT"
		};
	}
